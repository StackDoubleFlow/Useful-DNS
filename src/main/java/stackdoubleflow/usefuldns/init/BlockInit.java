...
import stackdoubleflow.usefuldns.objects.blocks.MadsFire;
...
public class BlockInit {
	...
	public static final MadsPortal MADS_PORTAL = new MadsPortal();
	public static final MadsFire MADS_FIRE = new MadsFire();
